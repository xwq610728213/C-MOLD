...
public class ValidatedContentJenaGraph implements ValidatedContent<Graph, ValidatedGraph> {
    ...
    public ValidatedContentJenaGraph(Time instance, Shapes shapes, ValidationOption... option) {
    ...
    public ValidatedContentJenaGraph(ValidatedContentJenaGraph validatedContentJenaGraph) {
    ...
    public ValidationOption getValidation_option() {
